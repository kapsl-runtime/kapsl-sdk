...
extern "C" llama_rs_status llama_rs_chat_msg_diff_to_oaicompat_json(
    ...
    *out_json = nullptr;
    ...
    try {
        ...
        nlohmann::ordered_json json_delta = nlohmann::ordered_json::object();
        ...
        if (msg_diff.tool_call_index != std::string::npos) {
            ...
            json_delta["tool_calls"] = nlohmann::ordered_json::array({ std::move(tool_call) });
        }
